...
const historicalEvents = [
    // 고대사 (선사시대 ~ 통일신라)
    { event: "구석기시대 시작", year: -700000, era: "ancient" },
    { event: "신석기시대 시작", year: -8000, era: "ancient" },
    { event: "청동기시대 시작", year: -2000, era: "ancient" },
    { event: "고조선 건국", year: -2333, era: "ancient" },
    { event: "위만조선 성립", year: -194, era: "ancient" },
    { event: "신라 건국", year: -57, era: "ancient" },
    { event: "고구려 건국", year: -37, era: "ancient" },
    { event: "백제 건국", year: -18, era: "ancient" },
    { event: "가야 연맹 성립", year: 42, era: "ancient" },
    { event: "백제 근초고왕", year: 346, era: "ancient" },
    { event: "고구려 광개토대왕", year: 391, era: "ancient" },
    { event: "신라 진흥왕", year: 540, era: "ancient" },
    { event: "백제 멸망", year: 660, era: "ancient" },
    { event: "고구려 멸망", year: 668, era: "ancient" },
    { event: "신라 삼국통일", year: 676, era: "ancient" },
    { event: "발해 건국", year: 698, era: "ancient" },

    // 중세사 (고려 ~ 조선후기)
    { event: "후고구려 건국", year: 901, era: "medieval" },
    { event: "고려 건국", year: 918, era: "medieval" },
    { event: "후삼국 통일", year: 935, era: "medieval" },
    { event: "고려 과거제 실시", year: 958, era: "medieval" },
    { event: "거란 침입", year: 993, era: "medieval" },
    { event: "강감찬의 귀주대첩", year: 1019, era: "medieval" },
    { event: "고려 금속활자 발명", year: 1234, era: "medieval" },
    { event: "몽골 침입", year: 1231, era: "medieval" },
    { event: "고려 강화도 천도", year: 1232, era: "medieval" },
    { event: "팔만대장경 제작", year: 1251, era: "medieval" },
    { event: "삼별초의 항쟁", year: 1270, era: "medieval" },
    { event: "이성계의 위화도 회군", year: 1388, era: "medieval" },
    { event: "조선 건국", year: 1392, era: "medieval" },
    { event: "한양 천도", year: 1394, era: "medieval" },
    { event: "태종 즉위", year: 1400, era: "medieval" },
    { event: "세종대왕 즉위", year: 1418, era: "medieval" },
    { event: "집현전 설치", year: 1420, era: "medieval" },
    { event: "측우기 발명", year: 1441, era: "medieval" },
    { event: "한글 창제", year: 1446, era: "medieval" },
    { event: "경국대전 완성", year: 1485, era: "medieval" },
    { event: "중종반정", year: 1506, era: "medieval" },
    { event: "임진왜란 발발", year: 1592, era: "medieval" },
    { event: "이순신의 한산대첩", year: 1592, era: "medieval" },
    { event: "정유재란", year: 1597, era: "medieval" },
    { event: "이순신의 명량대첩", year: 1597, era: "medieval" },
    { event: "정묘호란", year: 1627, era: "medieval" },
    { event: "정축호란", year: 1636, era: "medieval" },
    { event: "영조 즉위", year: 1724, era: "medieval" },
    { event: "정조 즉위", year: 1776, era: "medieval" },
    { event: "규장각 설치", year: 1776, era: "medieval" },
    { event: "수원 화성 건설", year: 1796, era: "medieval" },
    { event: "홍경래의 난", year: 1811, era: "medieval" },

    // 근현대사 (개항 ~ 광복)
    { event: "강화도 조약", year: 1876, era: "modern" },
    { event: "임오군란", year: 1882, era: "modern" },
    { event: "갑신정변", year: 1884, era: "modern" },
    { event: "동학농민운동", year: 1894, era: "modern" },
    { event: "갑오개혁", year: 1894, era: "modern" },
    { event: "을미사변", year: 1895, era: "modern" },
    { event: "독립협회 창립", year: 1896, era: "modern" },
    { event: "대한제국 수립", year: 1897, era: "modern" },
    { event: "을사늑약", year: 1905, era: "modern" },
    { event: "헤이그 특사", year: 1907, era: "modern" },
    { event: "일제강점기 시작", year: 1910, era: "modern" },
    { event: "3.1운동", year: 1919, era: "modern" },
    { event: "대한민국 임시정부", year: 1919, era: "modern" },
    { event: "6.10 만세운동", year: 1926, era: "modern" },
    { event: "광주학생항일운동", year: 1929, era: "modern" },
    { event: "윤봉길 의사의 의거", year: 1932, era: "modern" },
    { event: "창씨개명 실시", year: 1940, era: "modern" },
    { event: "광복", year: 1945, era: "modern" },

    // 현대사 (분단 ~ 현재)
    { event: "대한민국 정부 수립", year: 1948, era: "contemporary" },
    { event: "제주 4.3 사건", year: 1948, era: "contemporary" },
    { event: "한국전쟁 발발", year: 1950, era: "contemporary" },
    { event: "인천상륙작전", year: 1950, era: "contemporary" },
    { event: "1.4 후퇴", year: 1951, era: "contemporary" },
    { event: "휴전협정", year: 1953, era: "contemporary" },
    { event: "4.19 혁명", year: 1960, era: "contemporary" },
    { event: "5.16 군사정변", year: 1961, era: "contemporary" },
    { event: "한일기본조약", year: 1965, era: "contemporary" },
    { event: "새마을운동 시작", year: 1970, era: "contemporary" },
    { event: "7.4 남북공동성명", year: 1972, era: "contemporary" },
    { event: "6월 민주항쟁", year: 1987, era: "contemporary" },
    { event: "서울올림픽", year: 1988, era: "contemporary" },
    { event: "남북 UN 동시가입", year: 1991, era: "contemporary" },
    { event: "김영삼 정부 출범", year: 1993, era: "contemporary" },
    { event: "IMF 외환위기", year: 1997, era: "contemporary" },
    { event: "6.15 남북공동선언", year: 2000, era: "contemporary" },
    { event: "월드컵 공동개최", year: 2002, era: "contemporary" },
    { event: "평창동계올림픽", year: 2018, era: "contemporary" }
];
